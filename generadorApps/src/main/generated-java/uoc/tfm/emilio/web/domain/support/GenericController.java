...
import uoc.tfm.emilio.printer.support.TypeAwarePrinter;
import uoc.tfm.emilio.web.conversation.ConversationCallBack;
...
public abstract class GenericController<E extends Identifiable<PK>, PK extends Serializable> {
    ...
    public GenericController(GenericRepository<E, PK> repository, GenericPermission<E> permission, GenericPrinter<E> printer, String selectUri,
            String editUri) {
